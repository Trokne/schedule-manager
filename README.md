...
В случае ошибки выполнения команды установите Node.JS: https://nodejs.org/en/download/
...
Настроен базовый CI, который проверяет, что проект вообще собирается. Тесты, к сожалению, не прогоняет, т.к. их нет.
